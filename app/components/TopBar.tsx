...
export default function TopBar() {
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 flex items-start justify-between px-6 pt-[max(24px,env(safe-area-inset-top))] pb-6 bg-blanc-casse border-b border-line box-border h-[var(--topbar-height)]">
            {/* GAUCHE */}
            ...
            <div className="flex items-center text-right">
                ...
                <a
                    href="mailto:contact@museedigital.be"
